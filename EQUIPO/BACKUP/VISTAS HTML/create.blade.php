...
<link rel="stylesheet" type="text/css" href="{{asset('EstilosCMS/equipo/css/equipo_crear.css')}}">
    ...
    <div class="col-lg-10">
      <!-- Upload IMG-->
       <div class="conall">
       <div class="contup">
         <form class="fond" action="{{route('store.equipo')}}" method="POST" role="form" enctype="multipart/form-data">
         {{ csrf_field() }}
         <div class="up">
         <div class="content1">
         <div class="upimgx">
         ...
         <input type="text" class="inpute form-control {{ $errors->has('nombres') ? 'is-invaild' : ''}}" name="nombres" placeholder="Nombres Completos"  value="" id="imp"/>
       ...
       <div class="content_input">
       <input type="text" class="inpute form-control {{ $errors->has('cargo') ? 'is-invaild' : ''}}" name="cargo" placeholder="Cargo de la Persona"  value="" id="imp"/>
       @if ($errors->has('cargo'))
       <span class="invalid-feedback" role="alert">
       ...
       <input type="text" class="inpute form-control {{ $errors->has('correo') ? 'is-invaild' : ''}}" name="correo" placeholder="Correo Electrónico"  value="" id="imp"/>
