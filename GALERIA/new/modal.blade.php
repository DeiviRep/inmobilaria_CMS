<div class="modal fade in" id="modal-{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <p class="s-text">Este contenido se eliminará permanentemente<br> <span class="p-text">Esta acción no se puede deshacer.</span></p>
        </div>
